...
.recipe .recipe-image .category a {
  position: absolute;
  left: 0.8rem;
  bottom: 0.5rem;
  font-size: 0.7em;
...
.recipe:hover .recipe-image .category a {
  transform: translateY(0) translateZ(0);
}

.recipe .recipe-image .category a:hover {
...
.recipe .recipe-body .meta > * > * > span {
  margin-left: 6px;
  color: #666;
  font-size: 12.8px;
}

.recipe .recipe-body .description {
  margin-top: 12px;
  font-size: 0.9em;
  line-height: 1.4;
  color: #666;
